...
```{r}
# mean of data by region for DeathPer100k, DeathsPer1000, Years columns
meanByRegion = aggregate(data=joinedData,cbind(DeathsPer100k,DeathsPer1000,Years)~Region,mean)
...
write.csv(meanByRegion,"aggregatedData.csv", row.names=FALSE)
